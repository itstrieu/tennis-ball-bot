...
MOVEMENT_STEPS = {
    "step_forward": {"method": "move_forward", "speed": SPEED, "time": 0.4},
    "small_forward": {"method": "move_forward", "speed": int(SPEED * 0.5), "time": 0.3},
    "micro_forward": {"method": "move_forward", "speed": int(SPEED * 0.2), "time": 0.1},
